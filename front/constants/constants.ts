...
export const BASE_URL_CENTER = '/centres/landings'
export const BASE_URL_BOXES = '/centres/boxes'

export enum BoxCategories {
  MECABOX = 'MECABOX',
  DETAILINGBOX = 'DETAILINGBOX',
  WASHBOX = 'WASHBOX'
}
...
export const LOCATION = {
  ...
  PRESET_COORDS: {
    ...
    VALUE_CENTER: [1.8165658613781412, 48.626629683708835]
  }
}
