  ...
  <div>
    ...
    <main>
      ...
      <div class="content-section">
        ...
        <!-- tarifs -->
        <center-box-prices v-if="center" :center-id="center._id" :box-category="BoxCategories.WASHBOX" />
      </div>
...
/* LOAD BOX DATA */
getCurrentBoxTopics(BOXES.WASHING_BOX, TOPICS.WASHING, BOXES.MECANIC_BOX, BOXES.DETAILING_BOX)
</script>
