  ...
  <div>
    ...
    <main>
      ...
      <div class="content-section">
        ...
        <!-- tarifs -->
        <center-box-prices v-if="center" :center-id="center._id" :box-category="BoxCategories.DETAILINGBOX" />
      </div>
...
/* LOAD BOX DATA */
getCurrentBoxTopics(BOXES.DETAILING_BOX, TOPICS.DETAILING, BOXES.MECANIC_BOX, BOXES.WASHING_BOX)
</script>
