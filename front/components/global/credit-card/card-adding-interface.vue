<template>
  <section class="payment-container">
    <Fa icon="fa-regular fa-circle-xmark" class="cancel-button" @click="onClickCancel"></Fa>
...
const isNewCard = computed(() => !props.creditCard)
const paymentElementDOM = ref<HTMLElement>()

let submitFunction: TSetupSubmitFunction
...
async function mountCardElem() {
  ...
  submitFunction = await usePayment().mountSetupInput(paymentElementDOM.value)
}
